...
public class DartMain {
    ...
    public static void main(String[] args) throws Exception {
        Screens main = new Screens();
        while(programRunning) {
            main.mainMenu(); //Prints the question to User Story 1.1, I do this in a second function because I don't want to see a wall of text here
            ...
            main.screenChoice(Tools.validateChar(mainMenu, correctAnswers));
        }
    }
